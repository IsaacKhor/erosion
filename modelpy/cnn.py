...
def build_model():
    ...
    classifier.add(klayers.Dropout(0.45))
...
history = classifier.fit(train_x, train_y,
    ...
    callbacks=[ kcallb.ModelCheckpoint(
        'checkpoints/cnn2/checkpoint-{epoch:02d}-{loss:.2f}-{accuracy:.4f}.hdf5')])

classifier.save('models/cnn2-all.hdf5')
...
plt.savefig('figs/acc-cnn2-all.png')
